...
shield_n_sword_dict = {"Var" : 1, "Type" : shield_n_sword_types, "Class" : 1.4}

#Dual Swords (DS)
dual_sword_types = {"Regular Combo" : .72, "Revolving Slice" : .31, "Charging Slice" : .23, "Rolling Slice" : .19, "Unsheathe attack" : .23 }

dual_sword_dict = {"Var" : .70, "Type" : dual_sword_types, "Class" : 1.4}
...
great_sword_dict = {"Var" : [1.05, 1.10, 1.20, 1.30], "Type" : great_sword_types, "Class" : 4.8}
...
long_sword_dict = {"Var" : [1.05, 1.12], "Type" : long_sword_types, "Class" : 4.8}
...
hammer_dict = {"Var" : 1, "Type" : long_sword_types, "Class" : 5.2}
